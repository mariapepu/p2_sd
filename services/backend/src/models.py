...
from sqlalchemy import Column, ForeignKey, Integer, String, DateTime, Float, Enum, UniqueConstraint, Table
...
class Match(Base):
    ...
    __table_args__ = (UniqueConstraint('local_id', 'visitor_id', 'competition_id',
                                       'date'),)
